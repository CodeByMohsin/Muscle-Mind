...
# Accounts.register_user(%{email: "test@test1.com", password: "mak12345", is_admin: false, username: "puppies", name: "Andervrs", player_score: "1001" })
...
Accounts.register_user(%{email: "test@test10.com", password: "123456", is_admin: false, username: "The-Iron-Man", name: "mohsin"})
Accounts.register_user(%{email: "test1@test1.com", password: "123456", is_admin: false, username: "username-1", name: "user one", player_score: "500"})
Accounts.register_user(%{email: "test1@test2.com", password: "123456", is_admin: false, username: "username-2", name: "user two", player_score: "400"})
Accounts.register_user(%{email: "test1@test3.com", password: "123456", is_admin: false, username: "username-3", name: "user three", player_score: "800"})
