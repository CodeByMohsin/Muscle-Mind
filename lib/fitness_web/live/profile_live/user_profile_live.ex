defmodule FitnessWeb.UserProfileLive do
  ...
  def mount(params, session, socket) do
      ...
      socket =
        ...
        |> assign(:chart_data, chart_data_workout(socket.assigns[:current_user].id))
  ...
  def render(assigns) do
    ...
    <div class="scoreboard bg-blue-100 rounded-lg shadow-lg p-6 mb-8">
      ...
      <img src={assigns[:current_user].image} alt="user profile pic" class="w-32 h-w-32 rounded-full border-2 border-gray-800">
      </div>
      ...
      <span class="flex justify-center text-orange-600  pt-2 text-base font-poppins">
      @<%= assigns[:current_user].username %>
      </span>
       <a href="/score_board">
       <div class="buttonscore flex justify-center pt-4">
        <div class="box">T</div>
        <div class="box">O</div>
        <div class="box">T</div>
        <div class="box">A</div>
  ...
  def handle_event("open", _payload, socket) do
    {:noreply, assign(socket, three_dots: :on)}
  end
