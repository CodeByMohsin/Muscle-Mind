defmodule FitnessWeb.UserProfileLive do
  ...
  def render(assigns) do
    ...
    <div class="p-6 mb-8 bg-blue-100 rounded-lg shadow-lg scoreboard">
      <div>
        <a href="/users/settings" class="flex justify-end">
      ...
      <div class="flex justify-center pt-6 mt-6">
        <img
          src={assigns[:current_user].image}
          alt="user profile pic"
          class="w-32 border-2 border-gray-800 rounded-full h-w-32"
        />
      </div>
      ...
      <% else %>
        ...
        <.modal>
          <.live_component
            id={assigns[:current_user].id}
            module={FitnessWeb.ProfileLive.UpdateUserProfileForm}
    ...
    <div id="chart" phx-update="ignore" class="flex justify-items-center">
      <% bar_data =
        Jason.encode!([
          ["Total Sets", @chart_data.total_sets],
          ["Total Reps", @chart_data.total_reps],
          ["Total Weight", @chart_data.total_weight]
        ]) %>
      <%= raw(Chartkick.bar_chart(bar_data, stacked: true, colors: ["#FF5733"])) %>

      <% datetime_data =
        Jason.encode!(%{
          "2023-03-10 00:00:00 -0800": 45,
          "2023-06-10 00:00:00 -0800": 56,
          "2023-04-10 00:00:00 -0800": 54,
          "2023-09-10 00:00:00 -0200": 64,
          "2023-01-10 00:00:00 -0800": 84,
          "2023-07-10 00:00:00 -0800": 74,
          "2023-02-10 00:00:00 -0800": 64
        }) %>
